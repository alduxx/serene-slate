      ...
      <div className="container mx-auto px-6 py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <div className="mb-8 flex justify-center">
            <img src={profilePhoto} alt="Profile" className="w-48 h-48 rounded-full object-cover object-[center_30%] border-4 border-accent shadow-lg" />
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Button size="lg" onClick={() => scrollToSection('artigos')} className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-8">
              Ler Artigos
            </Button>
            <Button size="lg" variant="outline" onClick={() => scrollToSection('poesias')} className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-medium px-8">
              Ver Poesias
            </Button>
          </div>
        </div>
